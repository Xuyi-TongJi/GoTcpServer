...
type BroadCast struct {
	...
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` // Tp —— 1 世界聊天 2 玩家位置 3 动作 4 移动之后的坐标信息
...
type BroadCast_Content struct {
	Content string `protobuf:"bytes,3,opt,name=Content,proto3,oneof"` // 广播玩家的聊天信息
}
...
type BroadCast_ActionData struct {
	ActionData int32 `protobuf:"varint,5,opt,name=ActionData,proto3,oneof"` // 广播玩家具体的动作
}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x02, 0x52, 0x01, 0x56, 0x42, 0x0c, 0x5a, 0x05, 0x2e, 0x2e, 0x2f, 0x70, 0x62, 0xaa, 0x02, 0x02,
